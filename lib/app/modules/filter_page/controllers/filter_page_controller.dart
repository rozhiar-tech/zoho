...
class FilterPageController extends GetxController {
  ...
  getToFilteredJobs(selectedCategory, selectedDepartment, selectedJobType) async {
    ...
    final response = await http.get(
      Uri.parse('http://52.20.124.191:4000/api/filter_jobs?department_id=1&type=$selectedJobType&search=${searchController.text}'),
